      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <h2 ref={titleRef} className={styles.title}>
            Crafted Heritage,<br />
            <span className={styles.brand}>Global Luxury</span>
          </h2>
          ...
          <p ref={subtitleRef} className={styles.subtitle}>
            At IKATVA, we don’t just make bags; we preserve a 500-year-old heritage. Every piece you see is 100% handcrafted.
            <br /><br />
            <strong>Authentic. Timeless. Handmade.</strong>
          </p>
